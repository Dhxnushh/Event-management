...
export default function Popups(props){
    return (props.trigger) ? (
        <div className=" z-10 shadow-[3px_3px_5px] fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-3xl bg-[rgb(255,255,255)] p-6 w-[500px] h-[400px]">
